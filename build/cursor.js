var cursor=function(cursorRef){
  if(cursorRef.type=="img"){cursorRef.url=cursorRef.filePath;}
    ...
    if(cursorRef.hasOwnProperty("svgElement")){
	  ...
	  console.log(tempDomElement.getElementsByTagName("svg")[0]);
	  cursorRef.url="data:image/svg+xml;base64,"+btoa((new XMLSerializer).serializeToString(tempDomElement.firstChild));
	}
